...
// Appeal windows
export const APPEAL_WINDOW_DISPUTE_MS = 48 * 60 * 60 * 1000; // 48 hours for deal disputes
export const APPEAL_WINDOW_REJECTION_DAYS = 7; // 7 days for rejection appeals

// Ad format pricing keys
export const AD_FORMAT_KEYS = ['1_24', '2_48', 'no_delete', 'repost'] as const;
export type AdFormatKey = (typeof AD_FORMAT_KEYS)[number];

export const AD_FORMAT_LABELS: Record<AdFormatKey, { en: string; ru: string }> = {
  '1_24': { en: '1/24h', ru: '1/24ч' },
  '2_48': { en: '2/48h', ru: '2/48ч' },
  'no_delete': { en: 'No delete', ru: 'Без удаления' },
