...
- Security layer (encryption, auth validation, guards)
- TON blockchain integration
- MTProto worker and Telegram API integration
- Docker and deployment configuration
- Frontend components, pages, and UX flows
- Code review, testing, and debugging

AI-assisted:
- Boilerplate and scaffolding (NestJS modules, DTOs, controller stubs)
